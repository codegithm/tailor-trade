      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Join our platform to connect with tailors or showcase your designs
            </CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <AlertDescription>
                        ...
                        {typeof fe !== "string" && fe?.error && (
                          <details style={{ marginTop: 8 }}>
                            ...
                            >
                              {JSON.stringify(fe.error, null, 2)}
                            </pre>
                          </details>
                        )}
                        {typeof fe === "string" &&
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="customer">
                      Customer - I want to find tailors and designs
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value={UserRole.TAILOR} id="tailor" />
                    <Label htmlFor="tailor">
                      Tailor - I create and sell designs
                    </Label>
                  </div>
                </RadioGroup>
              </div>
